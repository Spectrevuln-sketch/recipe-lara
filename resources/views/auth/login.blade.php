    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="flex items-center justify-end mt-4">
                <button class="block text-white font-nunito font-semibold mx-auto py-2 my-1 w-full rounded-md border bg-green-400 border-green-400 hover:bg-green-500 transition ease-in duration-300" type="submit">LOGIN</button>
            </div>
            ...
            <div class="flex items-center justify-center mt-2">
                <a href="{{ route('register') }}" class="font-semibold font-nunito hover:text-green-400 transition ease-in duration-300">REGISTER</a>
            </div>
        </form>
    </x-jet-authentication-card>
</x-guest-layout>