<div>
    ...
    <div class="bg-gray-100 shadow-md">
        <div class="px-4 py-3 sm:px-8 md:px-16">
            <div class="flex items-center justify-center text-green-700 text-xl font-semibold font-lora mb-2">Total Recipe ({{$recipe->count()}})</div>
            <div class="flex justify-around items-center">
                <a href="{{ route('store-recipe') }}" class="bg-green-500 px-4 py-2 rounded-md hover:bg-green-400 shadow-md transform hover:scale-105 transition ease-out duration-300 font-nunito font-semibold text-white text-center">Add More</a>
            </div>
        </div>
    </div>
    <div class="px-4 py-3 mb-3 sm:px-8 md:px-16">
        <div class="flex items-center text-green-700 text-xl font-semibold font-lora mb-1 py-2">{{$user->name}}'s Recipes</div>
