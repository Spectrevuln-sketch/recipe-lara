            ...
            <ul class="flex items-center">
                <li>
                    <a class="flex items-center" href="{{ route('home')}}">
                        <svg class="h-16 fill-current text-green-500" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="font-bold font-lora italic text-3xl tracking-tight text-green-700 ml-3 pb-1" style="color: rgb(60, 192, 19)">ResepKu</span>
                    </a>
                </li>
            </ul>
            @if (Route::has('login'))
            <div class="flex">
                @auth
                    <div class="mb-1 flex items-center">
                        <x-jet-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                <button class="flex text-sm border-2 border-transparent rounded-full hover:border-green-500 focus:outline-none focus:border-green-500 transition duration-150 ease-in-out" style="color: rgb(60, 192, 19)">
                ...
                @else
                    <div class="flex items-center">
                        <a href="{{ route('login') }}" class="font-semibold font-nunito border border-green-600 text-green-600 rounded-md hover:bg-green-600 hover:text-white px-5 py-1 transition ease-in duration-300"  >LOGIN</a>
                    </div>
                @endif
                </div>
            @endif
