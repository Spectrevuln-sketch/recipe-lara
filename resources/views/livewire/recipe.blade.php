        ...
        <div class="lg:grid lg:grid-cols-2 bg-white overflow-hidden rounded-md shadow-md">
            ...
            <div class="px-3 py-2 h-90 lg:px-5">
                <div class="relative mb-2">
                    ...
                    <span class="font-lora text-green-500 font-bold text-2xl">{{$r->title}}</span>
                    <span class="block font-nunito font-semibold">{{User::where('id', '=', $r->user_id)->value('name')}}</span>
                </div>
                <div x-data="{
                            openTab: 1,
                            activeClasses: 'border-l-2 border-t-2 border-r-2 rounded-t text-green-500',
                            inactiveClasses: 'transition ease-out hover:text-green-500 duration-300'
                        }">
